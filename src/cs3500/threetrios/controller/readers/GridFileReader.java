...
public class GridFileReader implements ConfigurationFileReader<Cell[][]> {
  ...
  public Cell[][] readFile(String filePath) {
    try (FileReader reader = new FileReader(filePath);
      ...
      fillGrid(scanner, grid, rows, cols);

      // Check if the number of card cells is odd
  ...
  // private helper method to fill the grid
  private void fillGrid(Scanner scanner, Cell[][] grid, int rows, int cols) {
