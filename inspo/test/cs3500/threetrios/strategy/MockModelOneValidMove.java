...
/**
 * Mock 3x3 board where only one move is valid.
 */
public class MockModelOneValidMove implements ThreeTriosModel<ThreeTriosCard> {
   ...
   */
  public MockModelOneValidMove(Appendable log) {
    this.log = log;
