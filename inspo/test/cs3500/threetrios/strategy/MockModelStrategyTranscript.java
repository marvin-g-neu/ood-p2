...
/**
 * Mock 3x3 board with no holes that records when a strategy calls the model's
 * legalPlayToCell method.
 */
public class MockModelStrategyTranscript implements ThreeTriosModel<ThreeTriosCard> {
   ...
   */
  public MockModelStrategyTranscript(Appendable log) {
    model = new ThreeTriosModelImplementation();
    model.startGame("gridConfigFiles" + File.separator + "3x3AllCardCells.txt",
